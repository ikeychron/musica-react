      ...
      <div className="card border-light">
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            <a href={`https://${info.strFacebook}`} target="_blank" rel="nopener referrer">
              <i className="fab fa-facebook"></i>
            </a>
            <a href={`https://${info.strTwitter}`} target="_blank" rel="nopener referrer">
              <i className="fab fa-twitter"></i>
            </a>
            <a href={`${info.strLastFMChart}`} target="_blank" rel="nopener referrer">
